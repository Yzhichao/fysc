        ...
        <form id="waterGateInfoEditForm" method="post">
            <table class="grid">
                <tr>
                    ...
                    <input name="prnm" style="height: 29px;width:260px;" class="easyui-textbox" type="text" data-options="required:true" value="${waterGateInfo.prnm}"></td>
                </tr>
                <tr>
                    <td>所在镇（街）</td>
                    <td>
                ...
                <tr>
                    <td>闸孔数</td>
                    <td><input name="holeNum" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0" type="text" value="${waterGateInfo.holeNum}"></td>
                </tr>
                <tr>
                    <td>闸孔总净宽(m)</td>
                    <td><input name="holeWid" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:2" type="text" value="${waterGateInfo.holeWid}"></td>
                </tr>
                <tr>
                    <td>过闸流量(m3/s)</td>
                    <td><input name="fdsq" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:2" type="text" value="${waterGateInfo.fdsq}"></td>
                </tr>
                <!-- 
                <tr>
                    <td>备注</td>
