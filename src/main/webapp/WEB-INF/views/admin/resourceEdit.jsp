        ...
        <table  class="grid">
            <tr>
                ...
                <td>
                    ...
                    <input name="name" type="text" placeholder="请输入资源名称" value="${resource.name}" class="easyui-textbox"  style="height: 29px;" data-options="required:true" >
                </td>
                <td>资源类型</td>
                <td>
            ...
            <tr>
                <td>资源路径</td>
                <td><input name="url" type="text" value="${resource.url}" placeholder="请输入资源路径" class="easyui-textbox"  style="height: 29px;" ></td>
                <td>打开方式</td>
                <td>
            ...
            <tr>
                <td>菜单图标</td>
                <td><input name="icon" value="${resource.icon}" class="easyui-textbox"  style="height: 29px;"/></td>
                <td>排序</td>
