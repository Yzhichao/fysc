    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userAddForm" method="post">
            <table class="grid">
                <tr>
                    <td>登录名</td>
                    <td><input name="loginName" type="text" placeholder="请输入登录名称" class="easyui-textbox"  style="height: 29px;" data-options="required:true" value=""></td>
                    <td>姓名</td>
                    <td><input name="name" type="text" placeholder="请输入姓名" class="easyui-textbox"  style="height: 29px;" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td>密码</td>
                    <td><input name="password" type="password" placeholder="请输入密码" class="easyui-textbox"  style="height: 29px;" data-options="required:true"></td>
                    <td>性别</td>
                    <td>
                ...
                <tr>
                    <td>年龄</td>
                    <td><input type="text" name="age" class="easyui-numberbox" style="height: 29px;"/></td>
                    <td>用户类型</td>
                    <td>
                ...
                <tr>
                    <td>电话</td>
                    <td>
                        <input type="text" name="phone" class="easyui-numberbox"  style="height: 29px;"/>
                    </td>
                    <td>用户状态</td>
                    <td>
