...
<div style="padding: 3px;">
    <form id="resourceAddForm" method="post">
        <table class="grid">
            <tr>
                <td>资源名称</td>
                <td><input name="name" type="text" placeholder="请输入资源名称" class="easyui-textbox"  style="height: 29px;" data-options="required:true" ></td>
                <td>资源类型</td>
                <td>
            ...
            <tr>
                <td>资源路径</td>
                <td><input name="url" type="text" placeholder="请输入资源路径" class="easyui-textbox"  style="height: 29px;" data-options="width:140,height:29" ></td>
                <td>打开方式</td>
                <td>
            ...
            <tr>
                <td>菜单图标</td>
                <td ><input name="icon" class="easyui-textbox"  style="height: 29px;"/></td>
                <td>排序</td>
