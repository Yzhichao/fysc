    ...
    $(function() {
        ...
        $('#userEditForm').form({
            ...
            onSubmit : function() {
                ...
                if(isValid){
                	var tree = $('#userAddQy').combotree('tree');
                	if(tree.tree('getSelected')==null){
                		$('#userAddQy').combotree('setValue','${user.dscd}');
                	}
                }
                return isValid;
            },
        ...
        <form id="userEditForm" method="post">
            ...
            <table class="grid">
                <tr>
                    ...
                    <input name="loginName" type="text" placeholder="请输入登录名称" class="easyui-textbox"  style="height: 29px;" data-options="required:true" value="${user.loginName}"></td>
                    <td>姓名</td>
                    <td><input name="name" type="text" placeholder="请输入姓名" class="easyui-textbox"  style="height: 29px;" data-options="required:true" value="${user.name}"></td>
                </tr>
                <tr>
                    <td>密码</td>
                    <td><input type="text" name="password" class="easyui-textbox"  style="height: 29px;"/></td>
                    <td>性别</td>
                ...
                <tr>
                    <td>年龄</td>
                    <td><input type="text" name="age" value="${user.age}" class="easyui-numberbox" style="height: 29px;"/></td>
                    <td>用户类型</td>
                ...
                <tr>
                    <td>电话</td>
                    <td>
                        <input type="text" name="phone" class="easyui-numberbox" value="${user.phone}" style="height: 29px;"/>
                    </td>
                    <td>用户类型</td>
                ...
                <tr>
                    <td>区域</td>
                    <td><select id="userAddQy" name="dscd" style="width: 140px; height: 29px;" class="easyui-validatebox" data-options="required:true"></select></td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
