        ...
        <form id="roleEditForm" method="post">
            <table class="grid">
                <tr>
                    ...
                    <input name="name" type="text" placeholder="请输入角色名称" class="easyui-textbox"  style="height: 29px;" data-options="required:true" value="${role.name}"></td>
                </tr>
                <tr>
                    <td>排序</td>
                ...
                <tr>
                    <td>备注</td>
                    <td colspan="3">
                    <input class="easyui-textbox" name="description" data-options="multiline:true" style="height:60px" value="${role.description}">
                    </td>
                </tr>
            </table>
        </form>
