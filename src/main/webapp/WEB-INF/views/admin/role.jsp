...
<script type="text/javascript">
    ...
    $(function() {
        roleDataGrid = $('#roleDataGrid').datagrid({
            ...
            onLoadSuccess:function(data){
                ...
                $('.tcfw-easyui-linkbutton-ok').linkbutton({text:'地图授权'});
    ...
    function grantTcfwFun(id) {
        ...
        parent.$.modalDialog({
            ...
            width : 500,
            height : 500,
            href : '${path }/tcfw/grantPage?id=' + id,
            buttons : [ {
                text : '确定',
                handler : function() {
                	 parent.$.modalDialog.openner_dataGrid = roleDataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                     var f = parent.$.modalDialog.handler.find('#tcfwGrantForm');
                     f.submit();
                }
            } ]
        });
