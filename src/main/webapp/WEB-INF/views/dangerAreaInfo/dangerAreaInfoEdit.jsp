    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="dangerAreaInfoEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>位置</td>
                    <td><input name="id"  type="hidden"  value="${dangerAreaInfo.id}">
                    <input name="add" style="height: 29px;width:260px;" class="easyui-textbox" type="text" data-options="required:true" value="${dangerAreaInfo.add}"></td>
                </tr>
                <tr>
                    <td>危险区名称</td>
                    <td><input name="dzName" style="height: 29px;width:260px;" class="easyui-textbox" type="text" data-options="required:true" value="${dangerAreaInfo.dzName}"></td>
                </tr>
                <tr>
                    <td>易受灾类型</td>
                ...
                <tr>
                    <td>房屋数量</td>
                    <td><input name="hsNum" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0" type="text" value="${dangerAreaInfo.hsNum}"></td>
                </tr>
                <tr>
                    <td>受威胁人数</td>
                    <td><input name="thpp" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0" type="text" value="${dangerAreaInfo.thpp}"></td>
                </tr>
                <tr>
                    <td>重要设施、厂矿企业</td>
