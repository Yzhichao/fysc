    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="bridgeInfoEditForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>位置</td>
                    <td><input name="id"  type="hidden"  value="${bridgeInfo.id}">
                    <input name="addvnm" style="height: 29px;width:260px;" class="easyui-textbox" type="text" data-options="required:true" value="${bridgeInfo.addvnm}"></td>
                </tr>
                <tr>
                    <td>桥梁名称</td>
                    <td><input name="brName" style="height: 29px;width:260px;" class="easyui-textbox" type="text" data-options="required:true" value="${bridgeInfo.brName}"></td>
                </tr>
                <tr>
                    <td>所在河流</td>
                ...
                <tr>
                    <td>桥长(m)</td>
                    <td><input name="brLen" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:2" type="text" value="${bridgeInfo.brLen}"></td>
                </tr>
                <tr>
                    <td>桥宽(m)</td>
                    <td><input name="brWid" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:2" type="text" value="${bridgeInfo.brWid}"></td>
                </tr>
                <tr>
                    <td>桥高(m)</td>
                    <td><input name="brHight" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:2" type="text" value="${bridgeInfo.brHight}"></td>
                </tr>
                <tr>
                    <td>类型</td>
