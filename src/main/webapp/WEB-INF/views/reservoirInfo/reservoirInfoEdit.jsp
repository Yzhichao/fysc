    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="reservoirInfoEditForm" method="post">
            <table class="grid">
                <tr>
                    <td>水库名称</td>
                    <td><input name="id"  type="hidden"  value="${reservoirInfo.id}">
                    <input name="rsname" style="height: 29px;width:260px;" class="easyui-textbox" type="text" data-options="required:true" value="${reservoirInfo.rsname}"></td>
                </tr>
                <tr>
                    <td>所在镇（街）</td>
                    <td>
                ...
                <tr>
                    <td>最大坝高(m)</td>
                    <td><input name="mdMxHig" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="precision:2" type="text" value="${reservoirInfo.mdMxHig}"></td>
                </tr>
                <tr>
                    <td>设计洪水位(m)</td>
                    <td><input name="dsflz" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="precision:2" type="text" value="${reservoirInfo.dsflz}"></td>
                </tr>
                <tr>
                    <td>总库容(万m3)</td>
                    <td><input name="ttcp" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="precision:2" type="text" value="${reservoirInfo.ttcp}"></td>
                </tr>
                <tr>
                    <td>经度</td>
