...
<tr>
    ...
    <td><input name="prg" style="height: 29px;width:260px;" class="easyui-textbox" type="text"></td>
                ...
                <tr>
                    <td>经度(°)</td>
                    <td><input id="dangerPointsInfoAddJd" name="lgtd" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:5,required:true" type="text" ><a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-magnifying-glass',plain:true" onclick="selMap('dangerPointsInfoAddJd','dangerPointsInfoAddWd');">查看地图</a></td>
                </tr>
                <tr>
                    <td>纬度(°)</td>
                    <td><input id="dangerPointsInfoAddWd" name="lttd" style="height: 29px;width:260px;" class="easyui-numberbox" data-options="min:0,precision:5,required:true" type="text" ></td>
                </tr>
            </table>
        </form>
    </div>
